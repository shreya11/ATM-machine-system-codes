...
{
  char fdd1[10],fdd2[10],fdd3[4];
	float fdd4;
  struct kotakMahindra *next;   
  struct kotakMahindra *next5;      
  //struct kotakMahindra *temp;
  int AccountNo, PIN;
  char userName[20];                 
  float currBal;
} *head = NULL, *temp;		    
struct kotakMahindra*head5=NULL;
struct kotakMahindra*curr5=NULL;
...
void kotak_bank()  // function hdfc_banc created.
{
	char dd1[10];
	char dd2[10];
	char dd3[4];
...
if (k1.is_open())
{
   ...
   for (int i=0;i<5;i++)// transffering information of a file(which is in a linked list) from a terminal via creation a dummy linked list and stored it.
   {
   		...
   		if (curr5==NULL)
   		{
   				head5=(struct kotakMahindra*)malloc (sizeof (struct kotakMahindra));
   			curr5=head5;
   			k1 >> dd1; 
   			strcpy(curr5->fdd1,dd1);
  
   			k1 >> dd2; 
   			strcpy(curr5->fdd2,dd2); 
   			k1 >> dd3; 
   			strcpy(curr5->fdd3,dd3); 
   			k1 >> dd4; 
   			curr5->fdd4=dd4;
		...
		{
			curr5->next5=(struct kotakMahindra*)malloc (sizeof (struct kotakMahindra));
			curr5=curr5->next5;
			k1 >> dd1; 
   			strcpy(curr5->fdd1,dd1);
...
for (curr5=head5;curr5!=NULL;curr5=curr5->next5)
	{
...
for(curr5=head5;curr5!=NULL;curr5=curr5->next5)
	...
	if(strcmp(curr5->fdd1,pq)==0) 
		{
		cout<<" \n \n you have successfully enterd your account number \n \n ";
		cout<<" \n hello Mr/Mrs :"<< curr5->fdd2<<" \n ";
		TERMINAL:
		cout<<" \n Enter your 4 digit PIN number";
		cin>> z;
			if(strcmp(curr5->fdd3,z)==0) 
			{
				cout<<"\n \n \n Hello Mr/Mrs : "<<curr5->fdd2<<"\n";
				...
				//	{
						...
						switch(abc)
						{
							...
							//{
								...
								if(lh<=20000 &&  lh<=curr5->fdd4)
								{	
									curr5->fdd4=curr5->fdd4-lh;
									cout<<"  \n Mr/Mrs :"<<curr5->fdd2;
									cout<<"\n your new balance is : \n"<<curr5->fdd4;
								...
								else if (lh >= 20000 &&  lh<=curr5->fdd4 )
								{
									cout<< " \n Amount should not be more than 20,000";			
								}
						...
						//{
							...
							if(500 <=curr5->fdd4)
							{
								curr5->fdd4=curr5->fdd4-500;
 								cout<< " \n you have withdrawn rs.500 \n";
								cout<< " \n your new balance is :"<< curr5->fdd4;
							}
							else
								cout<< " \n Insufficient balance \n";
							break;
				...
				case 3:
					cout<<"\n Account inquiery :";
					cout<<"\n  \t Hello Mr/Mrs                       : "<<curr5->fdd2;
					cout<<"\n  \t Your pin number is                 : "<<curr5->fdd3;
					cout<<"\n  \t Current balance in your account is : "<<curr5->fdd4;
					cout<<"\n  \t  Your account number is            : "<<curr5->fdd1;
			         break;
					...
					if(kg== 'y' || kg== 'Y')
					{
						...
						cout<<" \n \n please re-enter enter your old pin number :"; // aiya pin number khoto hoy to b access thay che :(
						cin>> hr;
						if(strcmp(curr5->fdd3,hr)==0)
						{
							cout<<" \n please enter your new PIN number: ";
							cin>> fv;
							strcpy(curr5->fdd3,fv);
							cout<<"\n your new PIN number is :"<< curr5->fdd3;	
				...
				case 5:
					cout<<"\n Your information after editing:";
					cout<<"\n \t  Account number :"<<curr5->fdd1;
					cout<<"\n \t User name       :"<<curr5->fdd2;
					cout<<"\n \t PIN number      :"<<curr5->fdd3;
					cout<<"\n \t Current balance :"<< curr5->fdd4;
				break;
...
FILE :
	ofstream fwrt;// will over write the new information to the file(edited information)
      fwrt.open("KOTAK.dat");
	struct kotakMahindra*temp5=NULL;
      if (fwrt.is_open())
	{
		for (temp5=head5;temp5!=NULL;temp5=temp5->next5)
		{
			fwrt<< temp5->fdd1<<"\n";
			fwrt<< temp5->fdd2<<"\n";
			fwrt<< temp5->fdd3<<"\n";
